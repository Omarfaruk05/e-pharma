...
const refreshTokenService = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let newAccessToken = "";
    if (role === user_1.ENUM_ROLE.SUPER_ADMIN ||
        role === user_1.ENUM_ROLE.SUPER_ADMIN ||
        role === user_1.ENUM_ROLE.USER) {
        const isUserExist = yield user_model_1.User.findOne({ _id }, { _id: 1, password: 1, role: 1 }).lean();
        if (!isUserExist) {
            throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "User does not exist.");
        }
